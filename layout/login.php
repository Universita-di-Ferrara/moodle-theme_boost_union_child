...
require_once($percorsoIncludes . '/footnote.php');


// Include the template content for the static pages.
require_once($percorsoIncludes . '/staticpages.php');

// Include the template content for the info banners.
require_once($percorsoIncludes . '/infobanners.php');

// Render login.mustache from boost_union.
echo $OUTPUT->render_from_template('theme_boost_union_child/login', $templatecontext);